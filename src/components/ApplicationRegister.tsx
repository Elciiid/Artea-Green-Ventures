          ...
          <Table className="min-w-[840px] border-collapse text-left">
                ...
                {COLUMNS.map((col) => {
                  ...
                  return (
                    <TableHead
                      ...
                      className="h-auto px-4 py-3 first:pl-1 last:pr-1"
                    >
                      <button
                        type="button"
            ...
            <TableBody>
              {rows.map((app) => (
                <TableRow
                  key={app.id}
                  className="border-ash/15 last:border-b-0 hover:bg-bone/[0.04]"
                >
                  <TableHead scope="row" className="h-auto whitespace-nowrap py-3.5 pl-1 pr-4 align-top">
                    <Link
                  ...
                  <TableCell className="max-w-[280px] p-0 py-3.5 pr-4 whitespace-normal align-top">
                  ...
                  <TableCell className="p-0 py-3.5 pr-4 align-top text-sm text-bone">
                    {app.sector}
                  </TableCell>
                  <TableCell className="p-0 py-3.5 pr-4 align-top text-sm text-bone">
                    {app.location}
                  </TableCell>
                  <TableCell className="p-0 py-3.5 pr-4 align-top">
                    <StatusChip stage={app.stage} />
                  </TableCell>
                  <TableCell className="p-0 py-3.5 pr-4 align-top text-sm text-bone">
                    {app.lead}
                  </TableCell>
                  <TableCell className="p-0 whitespace-nowrap py-3.5 pr-1 align-top font-mono text-xs text-ash">
