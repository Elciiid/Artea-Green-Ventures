...
import sydney from "../../../../public/images/site/Sydney Gateway 2_edited.jpg";
...
export default function CtaSection() {
  return (
    <section className="relative isolate overflow-hidden bg-rail text-rail-ink">
      <Image
        src={sydney}
        alt="Rendered aerial view of the Sydney Gateway infrastructure project"
        fill
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 lg:px-10">
        ...
        <p className="mt-6 max-w-lg text-base font-light leading-relaxed text-rail-ink/75">
          Submit an application, invite your team or pull the latest verified
          figures for your board pack.
        </p>
        <Link
          href="/dashboard"
